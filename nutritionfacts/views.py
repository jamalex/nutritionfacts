...
def statistics(request):
    ...
    for channel in channels:
        ...
        ChannelStatistics.objects.create(
            ...
            sess_anon_count_no_visitor_id=channel.get("sacnv"),
            users_with_logs=channel.get("uwl"),
            anon_visitors_with_logs=channel.get("vwl"),
    ...
    for facility in facilities:
        ...
        FacilityStatistics.objects.create(
            ...
            sess_anon_count_no_visitor_id=facility.get("sacnv"),
            users_with_logs=facility.get("uwl"),
            anon_visitors_with_logs=facility.get("vwl"),
            class_count=facility.get("crc"),
            group_count=facility.get("grc"),
            birth_year_stats_learners=birth_year_stats_learners,
            birth_year_stats_non_learners=birth_year_stats_non_learners,
            gender_stats_learners=gender_stats_learners,
            gender_stats_non_learners=gender_stats_non_learners,
